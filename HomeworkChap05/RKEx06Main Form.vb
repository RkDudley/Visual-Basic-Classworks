' Name:             Guessing Game Project lesson c exercise 6 
...
Public Class frmMain
    ...
    Private Sub BtnGuess_Click(sender As Object, e As EventArgs) Handles BtnGuess.Click
        ...
        'store how many time user have been guessed
        intCount += 1

        'maximun user can guess not more than 5 times
        If intCount >= 5 AndAlso intGuess <> intGen Then
            lblMsg.Text = "The correct number is " & intGen.ToString
        Else
